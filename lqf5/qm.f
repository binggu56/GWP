      program main
c     -----------------------------------------------
c     trajectory-based gasussian basis for barrier transmisson
c     ------------------------------------------------------------------
      use cdat
...
!     grid size
      ...
      xl = q0-2.d0*dsqrt(pow/a0)
      xr = q0+2.d0*dsqrt(pow/a0)
...
!1024  format(20(f6.4,1x))  
      ...
      write(*,*) 'initial condition number', cnum
