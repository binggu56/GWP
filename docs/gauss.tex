...
\be H_{mn} = \bra g_{m} | -\frac{\hbar^{2}}{2m}\grad^{2} + V(x) | g_{n} \ket . \ee
...
\be H_{mn} - \im \dot{M}_{mn} = \bra g_{m} | d_{0}+d_{1}(x-q_n)+d_{2}(x-q_n)^2 | g_{n} \ket . \ee
...
\be f_{rep}(r) = 1 - \frac{1}{1+\exp(-2k(r-r_0))} \ee 
