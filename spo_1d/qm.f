...
!	write(57,1000) e0,csave,c0

!     print final wavepacket and non-classical momentum
      do i=1,n1
        write(55,1000) x(i),abs(psi(i))**2
      enddo

      do i=1,n1-1
        r = (abs(psi(i+1))-abs(psi(i)))/abs(psi(i))/dx
        write(104,1000) x(i),r
      enddo
!--------------------------------------------------
!	do i=2,n1
...
!101        DO 3 J=1,NT
!         do jj=1,nout
!          call cheb(n1,dt,v,ak2,psi)
!         enddo
!         CALL AVEC(N1,psi0,psia,psib,psi,c0,c1,c2,c3,c4)
!         t=dt*j*nout
!         write(200,*) t,c0
!         write(201,*) t,c1
!         write(202,*) t,c2
...
!  3     CONTINUE
!        stop
!cccccccccccccc do Chebyshev operator order sequence ccccccccccccccc
!102          call seq(n1,nt,v,ak2,psi0,psia,psib,psi)
!        close(200)
!        close(201)
!        close(202)
!        close(203)
