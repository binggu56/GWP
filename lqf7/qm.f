...
c     with trajectories moving as quantum trajectories 
c     with linear quantum force 
c     ---------------------------------------------------
      use cdat
...
c      call eigen(nb,mat,cnum)
c      write(*,1234) cnum
c1234  format('initial condition number',e13.6)
...
!      call rep(nb,w,r0,x,p,dt,dxp)
      ...
      call qpot(r0,Nb,ddv,c,am,p,x,w,u,du)
...
c       print out trajectories in phase space
        do i=1,Nb
...
c      if(cnum .gt. 1.d08) then
c        write(*,*) 'Condition number too big.'
c        stop
c      endif

c      call zposv('U', Nb, 1, aux, nb, b, nb, INFO)
      call ZCPOSV('U',Nb,1,aux,nb,b,nb,dc,nb,WORK,SWORK,
     +             RWORK, ITER, INFO)
...
c      call zposv('U', Nb, 1, aux, nb, c0, nb, INFO)
      call ZCPOSV('U',Nb,1,aux,nb,c0,nb,c,nb,WORK,SWORK,
     +             RWORK, ITER, INFO)
